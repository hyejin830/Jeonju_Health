...
public class BasicListViewAdapter extends BaseAdapter {
    ...
    private ArrayList<BasicList> listViewItemList = new ArrayList<BasicList>() ;

    // ListViewAdapter의 생성자
    public BasicListViewAdapter() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView descTextView = (TextView) convertView.findViewById(R.id.addr) ;

        BasicList listViewItem = listViewItemList.get(position);
